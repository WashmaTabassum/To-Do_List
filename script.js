...
function doAbout() {
  ...
  document.getElementById("divabout").innerHTML = "Developer is Washma. This Todo list helps you manage your tasks efficiently and effectively. You can mark tasks as done, remove them, or mark them as important.";
}
